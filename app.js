...
// console.log(`hazirSayi  of cicle: ${hazirSayi.toFixed(3)}`);
// console.log(`hazirSayi  of cicle: ${Math.floor(hazirSayi)}`);
// console.log(`hazirSayi  of cicle: ${Math.trunc(hazirSayi)}`);
// console.log(`hazirSayi  of cicle: ${Math.round(hazirSayi)}`);
